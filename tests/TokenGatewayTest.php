...
class TokenGatewayTest extends GatewayTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->gateway = new TokenGateway($this->getHttpClient(), $this->getHttpRequest());
    ...
    public function testInheritsServerGateway()
    {
        $this->assertInstanceOf('Omnipay\SagePay\ServerGateway', $this->gateway);
    }
